...
function createCurlDumperGetRequest(string $endpoint = '/api/users'): AbstractRequest
{
...
function createCurlDumperPostRequest(string $endpoint = '/api/users'): AbstractRequest
{
...
function createCurlDumperPutRequest(): AbstractRequest
{
...
function createCurlDumperDeleteRequest(): AbstractRequest
{
...
function createCurlDumperRequestWithQuery(): AbstractRequest
{
...
function createCurlDumperRequestWithHeaders(): AbstractRequest
{
    return new #[Get()] class() extends AbstractRequest
    {
        public function endpoint(): string
...
function createCurlDumperRequestWithContentTypeHeader(): AbstractRequest
{
    return new #[Post()] #[Json()] class() extends AbstractRequest
    {
        public function endpoint(): string
        {
            return '/api/users';
