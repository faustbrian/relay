...
describe('MockClient Fixture Integration', function (): void {
    ...
    it('sets recorder callback for fixture recording', function (): void {
    ...
    it('passes request to fixture for recording', function (): void {
        MockConfig::throwOnMissingFixtures(false);
        ...
        $fixture = Fixture::make('mock-client-test');
        $request = createMockClientTestRequest('/test-endpoint');
        ...
        // Response should contain the endpoint from the request
        expect($response->json('endpoint'))->toBe('/test-endpoint');

        // Fixture file should have been created
