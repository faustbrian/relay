 ...
 */
abstract class AbstractRequestException extends RuntimeException implements ProvidesSolution
{
     ...
     */
    public static function fromGuzzleException(GuzzleException $exception, AbstractRequest $request): static
    {
