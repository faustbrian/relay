...
/**
 * Adds debugging capabilities to Connector and AbstractRequest classes.
 *
...
trait HasDebuggingTrait
{
     ...
     * @param null|Closure(AbstractRequest, ?RequestInterface):void $handler Custom handler for request debugging
     */
