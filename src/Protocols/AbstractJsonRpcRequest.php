...
#[Post()]
#[Json()]
abstract class AbstractJsonRpcRequest extends AbstractRequest
{
    protected static ?IdGeneratorInterface $idGenerator = null;
     ...
     */
    public static function useIdGenerator(IdGeneratorInterface $generator): void
    {
