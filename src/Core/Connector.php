...
use Cline\Relay\Observability\Debugging\HasDebugging;
...
abstract class Connector
{
     ...
     */
    protected function sendRaw(Request $request): Response
    {
        // Build the full URL
        $url = $this->buildUrl($request);
     ...
     */
    protected function getActiveDebuggingState(Request $request): DebuggingState
    {
        // Request-level debugging takes precedence
