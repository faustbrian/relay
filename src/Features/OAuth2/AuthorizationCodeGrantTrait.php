 ...
 *
 * @phpstan-require-extends AbstractConnector
 *
 * @author Brian Faust <brian@cline.sh>
 */
trait AuthorizationCodeGrantTrait
{
     ...
     *
     * @return ($returnResponse is true ? Response : OAuthAuthenticatorInterface)
     */
    ...
    ): OAuthAuthenticatorInterface|Response {
    ...
    public function refreshAccessToken(
        OAuthAuthenticatorInterface|string $refreshToken,
        bool $returnResponse = false,
        ?callable $requestModifier = null,
    ): OAuthAuthenticatorInterface|Response {
        $this->oauthConfig()->validate();

        $oldAuthenticator = $refreshToken instanceof OAuthAuthenticatorInterface ? $refreshToken : null;
        ...
        if ($oldAuthenticator instanceof OAuthAuthenticatorInterface) {
     ...
     */
    public function getUser(OAuthAuthenticatorInterface $authenticator, ?callable $requestModifier = null): Response
    {
     ...
     */
    protected function createOAuthAuthenticatorFromResponse(Response $response, ?string $fallbackRefreshToken = null): OAuthAuthenticatorInterface
    {
        $data = $response->json();
    ...
    /**
     * Create the OAuthAuthenticatorInterface instance.
     *
